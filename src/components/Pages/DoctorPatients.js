...
const DoctorPatients = ({ user, onLogout }) => {
  ...
  return (
    <Layout user={user} sidebarItems={sidebarItems} onLogout={onLogout}>
      <div className="content-body">
        <h1 className="content-title">Patients</h1>
          ...
          {filteredPatients.map((patient) => (
            <div key={patient.id} className="patient-card">
              ...
              <div className="patient-actions">
                ...
                <button className="btn btn-primary btn-small" onClick={() => alert('Scheduling appointment...')}>Schedule Appointment</button>
                <button className="btn btn-secondary btn-small" onClick={() => alert('Sending message...')}>Send Message</button>
              </div>
            </div>
          ))}
        </div>
